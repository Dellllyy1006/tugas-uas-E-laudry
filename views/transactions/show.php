<div class="row">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="text-center mt-4">
                    <form action="<?= Controller::url('transaction/next/' . $transaction['id']) ?>" method="post" style="display: inline;">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="<?= Controller::url('transaction/print/' . $transaction['id']) ?>" class="btn btn-primary btn-block mb-2" target="_blank">
                    <i class="fas fa-print mr-2"></i> Cetak Nota
                </a>
                
                <a href="<?= Controller::url('transaction') ?>" class="btn btn-secondary btn-block mb-2">
                    <i class="fas fa-arrow-left mr-2"></i> Kembali
                </a>
                
                <?php if ($transaction['status'] === 'baru'): ?>
                <hr>
                <a href="<?= Controller::url('transaction/delete/' . $transaction['id']) ?>" class="btn btn-outline-danger btn-block btn-delete">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= Controller::url('transaction/status/' . $transaction['id']) ?>" method="post">
