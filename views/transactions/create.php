<form action="<?= Controller::url('transaction/store') ?>" method="post" id="transactionForm">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <div class="text-right">
                        <a href="<?= Controller::url('transaction') ?>" class="btn btn-secondary mr-2">
...
$(document).ready(function() {
    ...
    $('#checkPromo').on('click', function() {
        ...
        $.get('<?= Controller::url('promo/validate') ?>', { code: code, subtotal: subtotal }, function(response) {
            if (response.success) {
