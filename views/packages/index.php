<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="<?= Controller::url('package/create') ?>" class="btn btn-primary btn-sm">
        ...
        <table class="table table-bordered table-hover datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= Controller::url('package/edit/' . $package['id']) ?>" class="btn btn-sm btn-warning" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="<?= Controller::url('package/delete/' . $package['id']) ?>" class="btn btn-sm btn-danger btn-delete" title="Hapus">
