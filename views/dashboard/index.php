...
<div class="row">
    <div class="col-lg-3 col-6">
        <div class="small-box bg-info">
            ...
            <a href="<?= Controller::url('transaction') ?>" class="small-box-footer">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-warning">
            ...
            <a href="<?= Controller::url('transaction') ?>&status=baru" class="small-box-footer">
                Lihat detail <i class="fas fa-arrow-circle-right"></i>
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-danger">
            ...
            <a href="<?= Controller::url('transaction') ?>&status=siap_ambil" class="small-box-footer">
                Lihat detail <i class="fas fa-arrow-circle-right"></i>
            </a>
        </div>
    </div>
...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= Controller::url('transaction') ?>" class="btn btn-sm btn-primary">
                        Lihat Semua
                    </a>
                </div>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= Controller::url('transaction/show/' . $trx['id']) ?>" class="btn btn-sm btn-info">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="<?= Controller::url('transaction/create') ?>" class="btn btn-primary btn-block mb-3">
                    <i class="fas fa-plus-circle mr-2"></i>
                    Transaksi Baru
                </a>
                <a href="<?= Controller::url('customer/create') ?>" class="btn btn-outline-secondary btn-block mb-3">
                    <i class="fas fa-user-plus mr-2"></i>
                    Tambah Pelanggan
                </a>
                <a href="<?= Controller::url('tracking') ?>" target="_blank" class="btn btn-outline-info btn-block">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= Controller::url('transaction/show/' . $trx['id']) ?>" class="btn btn-sm btn-success">
